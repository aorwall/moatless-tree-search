...
from swesearch.benchmark.schema import TreeSearchSettings
from swesearch.feedback.novel_solution_feedback import NovelSolutionFeedback
from swesearch.value_function.terminal import TerminalValueFunction
...
SIMPLE_FEEDBACK = TreeSearchSettings(
    max_expansions=3,
    max_iterations=80,
    max_cost=1.0,
    ...
    reward_threshold=95,
    max_depht=20,
    selector=SimpleSelector(max_depth=20),
    value_function=TerminalValueFunction(completion_model=JsonCompletionModel())
)
