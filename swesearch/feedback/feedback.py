...
class FeedbackGenerator(BaseFeedbackGenerator, ABC):
    @abstractmethod
    ...
    def model_validate(cls, obj: Any) -> "FeedbackGenerator":
        if isinstance(obj, dict):
            ...
            feedback_class_path = obj.pop(
                "feedback_class",
                "moatless.feedback.reward_feedback.RewardFeedbackGenerator",
            )
            ...
            try:
                ...
                from swesearch.feedback.reward_feedback import RewardFeedbackGenerator
