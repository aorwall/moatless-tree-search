...
from moatless.completion.schema import ResponseSchema, AllMessageValues, ChatCompletionSystemMessage, \
    ChatCompletionUserMessage
from swesearch.utils.misc import save_to_json
...
class MultiAgentDebate(BaseModel):
    ...
    def format_agent_message(self, action_request, completion):
        if action_request:
            ...
            return ChatCompletionUserMessage(role="user", content=completion.choices[0].message.content)
        else:
            return None
