    ...
    def log_post_api_call(self, kwargs, response_obj, start_time, end_time):
        ...
        if original_response:
            try:
                ...
                if "choices" in original_response and "message" in original_response["choices"][0] and "content" in original_response["choices"][0]["message"]:
                    try:
